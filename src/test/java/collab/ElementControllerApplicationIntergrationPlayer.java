...
public class ElementControllerApplicationIntergrationPlayer {
	...
	public void setUp() {
		...
		UserBoundary playerUser = new UserBoundary(new UserId("2020a.alik","yuval@dotncs.com")
	...
	public void testGetElementWithNoParentElementInDbAfterOneCreation() throws Exception {
		// GIVEN the database is with one user  2020a.alik/yuval@dotncs.com
		ElementBoundary singleElement = new ElementBoundary(null,"Chair",
				"chairs",true, null, new User(new UserId("2020a.alik","yuval@dotncs.com")),null, null );
		singleElement = this.elementService.create("2020a.alik","manger@dotncs.com",singleElement);
	...
	public void testGetElementWithParentElementInDb() throws Exception {
		...
		firstElement = this.elementService.create("2020a.alik","manger@dotncs.com",firstElement);
		ElementBoundary secondElement = new ElementBoundary(null,"Chair",
				"chairs",true, null, new User(new UserId("2020a.alik","yuval@dotncs.com")),new Element(new ElementId(firstElement.getElementId().getDomain(),firstElement.getElementId().getId())), Collections.singletonMap("text", "test") );
		secondElement = this.elementService.create("2020a.alik","manger@dotncs.com",secondElement);
	...
	//Ali:: test get element by ID with empty data
		...
		//Ali:: test get element by ID with one element in the data
		@Test
