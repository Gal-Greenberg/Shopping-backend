...
public class ActionControllerApplicationIntegrationTests {
	...
	@BeforeEach
	public void setUp() {
		UserBoundary playerUser = new UserBoundary(new UserId("2020a.alik","player@dotbcs.com")
				, UserRole.PLAYER, "Yuval", ":)");
		UserBoundary managerUser = new UserBoundary(new UserId("2020a.alik","manger@dotbcs.com")
	...
	public void testInvokeActionsWithusersAndElements() throws Exception {
		...
		.mapToObj(i -> this.factory.createNewElement("2020a.alik@@"+i , "name "+i, "Item", true, new Date(), "2020a.alik@@player@dotbcs.com",
				null,  createAttributesMap(2)))
		.forEach(this.elementDao::save);
		String playerEmail = "player@dotbcs.com";
		String playerDomain = "2020a.alik";
		
		// WHEN I post 10 actions as an player
		IntStream.range(0, 10)
		.mapToObj(i -> this.actionConvertor.fromEntity(this.factory.createNewAction("2020a.alik@@"+i, "2020a.alik@@1", "2020a.alik@@player@dotbcs.com", 
		...
		// THEN the database invoked 10 action
	...
	public void testInvokeActionsWithusersAndElementsNotActive() throws Exception {
		...
		IntStream.range(0, 20)
		.mapToObj(i -> this.factory.createNewElement("2020a.alik@@"+i , "name "+i, "Item", false, new Date(), "2020a.alik@@player@dotbcs.com",
				null,  createAttributesMap(2)))
		.forEach(this.elementDao::save);
		String playerEmail = "player@dotbcs.com";
		String playerDomain = "2020a.alik";
	...
	public void testManagerInvokeActionsWithElementsActive() throws Exception {
		...
		assertThrows(Exception.class, ()->
		IntStream.range(0, 10)
		.mapToObj(i -> this.actionConvertor.fromEntity(this.factory.createNewAction("2020a.alik@@"+i, "2020a.alik@@1", "2020a.alik@@manger@dotbcs.com", 
				"type", new Date(), createAttributesMap(2))))
		.forEach(this.actionService::invoke));
	...
	public void testPlayerInvokeActionsWithElementsThatNotInDB() throws Exception {
		...
		assertThrows(Exception.class, ()->
		IntStream.range(0, 10)
		.mapToObj(i -> this.actionConvertor.fromEntity(this.factory.createNewAction("2020a.alik@@"+i, "2020a.alik@@300", "2020a.alik@@player@dotbcs.com", 
				"type", new Date(), createAttributesMap(2))))
		.forEach(this.actionService::invoke));
	...
	public void testPlayerInvokeActionsWithUserThatNotInDB() throws Exception {
		...
		assertThrows(Exception.class, ()->
		IntStream.range(0, 10)
		.mapToObj(i -> this.actionConvertor.fromEntity(this.factory.createNewAction("2020a.alik@@"+i, "2020a.alik@@2", "2020a.alik@@player1@dotbcs.com", 
				"type", new Date(), createAttributesMap(2))))
		.forEach(this.actionService::invoke));
