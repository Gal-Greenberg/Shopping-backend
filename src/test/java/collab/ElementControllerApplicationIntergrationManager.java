...
public class ElementControllerApplicationIntergrationManager {
	...
	public void setUp() {
		...
		UserBoundary singleUser = new UserBoundary(new UserId("2020a.alik","yuval@dotncs.com")
	...
	public void testPostNewElementIsSuccessful() throws Exception{
		...
		ElementBoundary singleElement = new ElementBoundary(null,"Chair",
				"chairs",true, null, new User(new UserId("2020a.alik","yuval@dotncs.com")),null, Collections.singletonMap("text", "test") );
		...
		assertThat(this.elementService.getAllElements())
			.isNotEmpty()
			.usingElementComparatorOnFields("active", "name", "elementAttributes")
	...
	public void testPutElementNameIsSuccessfull() throws Exception{
		...
		ElementBoundary singleElement = new ElementBoundary(null,"Chair",
				"chairs",true, null, new User(new UserId("2020a.alik","yuval@dotncs.com")),null, Collections.singletonMap("text", "test") );
		singleElement = this.elementService.create("2020a.alik","yuval@dotncs.com",singleElement);
		...
		assertThat(this.elementService.getSpecificElement(singleElement.getCreatedBy().getUserId().getDomain(),singleElement.getCreatedBy().getUserId().getEmail(),
				singleElement.getElementId().getDomain(),singleElement.getElementId().getId()))
		...
		public void testPostNewElementWithEmptyDataIsSuccess() throws Exception{
			...
			ElementBoundary e1 = new ElementBoundary(
					...
					true,
					null,
					new User(new UserId("2020a.alik","yuval.a@dotncs.com")),
					null,
			...
			assertThat(this.elementService.getAllElements())
				.isNotEmpty()
				.usingElementComparatorOnFields("type", "name", "elementAttributes")
				.containsExactly(e1);
		}
		...
		public void testPostNewElementWithTwoElenemtInDbIsSuccess() throws Exception{
			...
			this.elementService.create(
					...
					new ElementBoundary(
							...
							true,
							null,
							new User(new UserId("2020a.alik","yuval@dotncs.com")),
							null,
							Collections.singletonMap("text", "test")));
			...
			// THEN the database contains the new Element
			assertThat(this.elementService.getSpecificElement("2020a.alik", "yuval@dotncs.com", e1.getElementId().getDomain(), e1.getElementId().getId()))
			.isNotNull()
		...
		public void testupdateElementIsSuccessfull() throws Exception{
			...
			System.err.println(this.elementService.getSpecificElement("2020a.alik", "yuval@dotncs.com", e2.getElementId().getDomain(), e2.getElementId().getId()));

			// THEN the database is updated the element
			assertThat(this.elementService.getSpecificElement("2020a.alik", "yuval@dotncs.com", e2.getElementId().getDomain(), e2.getElementId().getId()))
			.isNotNull()
