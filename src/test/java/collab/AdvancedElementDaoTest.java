...
public class AdvancedElementDaoTest {
	...
	@BeforeEach
	public void setUp() {
		UserBoundary playerUser = new UserBoundary(new UserId("2020a.alik","yuval@dotbcs.com")
				, UserRole.PLAYER, "Yuval", ":)");
		UserBoundary managerUser = new UserBoundary(new UserId("2020a.alik","manger@dotncs.com")
	...
	public void testReadAllWithPagination() throws Exception {
		...
		IntStream.range(0, 20)
				.mapToObj(i -> this.factory.createNewElement("2020a.alik@@"+i , "name "+i, "Item", true, new Date(), "2020a.alik@@yuval@dotbcs.com",
						null,  createAttributesMap(2)))
				.forEach(this.elementDao::save);
		// WHEN I read 3 elements from page 6
		List<ElementBoundary> actual = this.advancedElementsService.getAllElements("2020a.alik", "yuval@dotbcs.com", 3, 6);
	...
	public void testReadAllWithPaginationByNameManager() throws Exception{
		...
		.mapToObj(i -> this.factory.createNewElement("2020a.alik@@"+i ,(i%2==0) ?name:""+i, "Item", true, new Date(), "2020a.alik@@yuval@dotbcs.com",
				null,  createAttributesMap(2)))
		.forEach(this.elementDao::save);
		
		// WHEN I read 5 elements from page 1 by name
		List<ElementBoundary> actual = this.advancedElementsService.getAllElementsByName("2020a.alik", "manger@dotncs.com",name, 5, 0);
	...
	public void testReadAllWithPaginationByManagerNotAllActive() throws Exception{
		...
		String name = "Test";
		IntStream.range(0, 10)
		.mapToObj(i -> this.factory.createNewElement("2020a.alik@@"+i ,name+i, "Item", (i%2==0)?true:false, new Date(), "2020a.alik@@yuval@dotbcs.com",
				null,  createAttributesMap(2)))
		.forEach(this.elementDao::save);
		
		// WHEN I read 10 elements from page 1 
		List<ElementBoundary> actual = this.advancedElementsService.getAllElements("2020a.alik", "manger@dotncs.com", 10, 0);
	...
	public void testReadAllWithPaginationByManagerAllElmentsNotActive() throws Exception{
		...
		String name = "Test";
		IntStream.range(0, 10)
		.mapToObj(i -> this.factory.createNewElement("2020a.alik@@"+i ,name+i, "Item", false, new Date(), "2020a.alik@@yuval@dotbcs.com",
				null,  createAttributesMap(2)))
		.forEach(this.elementDao::save);
	...
	public void testReadSpecicficWithPaginationByManagerAllElmentNotActive() throws Exception{
		...
		// WHEN I read 10 elements from page 1 
		ElementBoundary actual = this.advancedElementsService.getSpecificElement("2020a.alik", "manger@dotncs.com", "2020a.alik", "1");
	...
	public void testReadAllWithPaginationByPlayerNotAllActive() throws Exception{
		...
		// WHEN I read 10 elements from page 1 
		List<ElementBoundary> actual = this.advancedElementsService.getAllElements("2020a.alik", "yuval@dotbcs.com", 10, 0);
		// THEN I receive 5 elements
		assertThat(actual)
			.hasSize(5);
	}
	...
	public void testReadAllWithPaginationByPlayerSpecificElementNotActive() throws Exception{
		...
		this.advancedElementsService.getSpecificElement("2020a.alik", "yuval@dotbcs.com", "2020a.alik", "3"));
	...
	public void testGetElementsByType() throws Exception{
		...
		IntStream.range(0,2)
		.mapToObj(i -> this.factory.createNewElement("2020a.alik@@"+i ,"Test #"+i, type, true, new Date(), "2020a.alik@@yuval@dotbcs.com",
				null,  createAttributesMap(2)))
		.forEach(this.elementDao::save);
		
		IntStream.range(2,2+18)
		.mapToObj(i -> this.factory.createNewElement("2020a.alik@@"+i ,"Test #"+i, "OtherType", true, new Date(), "2020a.alik@@yuval@dotbcs.com",
				null,  createAttributesMap(2)))
		.forEach(this.elementDao::save);
		
		// WHEN I read the first 3 elements by type
		List<ElementBoundary> result = this.advancedElementsService.getAllElementsByType("2020a.alik", "manger@dotncs.com",type, 5, 0);
	...
	public void testGetElementsByTypeNotAllActivePlayer() throws Exception{
		...
		// AND the first two elements has the type Clothes
		IntStream.range(0,2)
		.mapToObj(i -> this.factory.createNewElement("2020a.alik@@"+i ,"Test #"+i, type, (i%2==0)?true:false, new Date(), "2020a.alik@@yuval@dotbcs.com",
				null,  createAttributesMap(2)))
		.forEach(this.elementDao::save);
		...
		// WHEN I read the first 3 elements by type
		List<ElementBoundary> result = this.advancedElementsService.getAllElementsByType("2020a.alik", "yuval@dotbcs.com",type, 5, 0);
	...
	public void testReadElementsByNamePlayerNotAllActive() throws Exception{
		...
		IntStream.range(0,2)
		.mapToObj(i ->  this.factory.createNewElement("2020a.alik@@"+i ,name, "OtherType", (i%2==0)?true:false, new Date(), "2020a.alik@@yuval@dotbcs.com",
				null,  createAttributesMap(2)))
		.forEach(this.elementDao::save);
		...
		List<ElementBoundary> result = this.advancedElementsService.getAllElementsByName("2020a.alik", "yuval@dotbcs.com",name, 3, 0);
	...
	public void testReadElementsByParent() throws Exception{
		...
		ElementEntity parent = this.factory.createNewElement("2020a.alik@@0" ,name, "OtherType", true, new Date(), "2020a.alik@@yuval@dotbcs.com",
				null,  createAttributesMap(2));
		...
		List<ElementBoundary> result = this.advancedElementsService.getAllElementsByParentElement("2020a.alik", "yuval@dotbcs.com", "2020a.alik", "0", 9, 0);
		System.err.println(result.size());
		// THEN we receive 1 elements 
	...
	public void testReadElementsByParentWithPaginationAndNotAllActive() throws Exception{
		...
		IntStream.range(1,10)
		.mapToObj(i ->  this.factory.createNewElement("2020a.alik@@"+i ,"Test #"+i, "OtherType", (i%2==0)?true:false, new Date(), "2020a.alik@@yuval@dotbcs.com",
				parent,  createAttributesMap(2)))
		.forEach(this.elementDao::save);
		
		// WHEN I read the first 2 elements by parent on page 2
		List<ElementBoundary> result = this.advancedElementsService.getAllElementsByParentElement("2020a.alik", "yuval@dotbcs.com", "2020a.alik", "0", 2, 2);
		System.err.println(result.size());
		// THEN we receive 2 elements 
