...
public interface EntityFactory {
	...
	public UserEntity createNewUser(String userId, String username, 
	...
	public ActionEntity createNewAction(String actionId, String elementId, String invokedBy, String actionType,
			java.util.Date createdTimestamp, Map<String,
			Object> actionAttributes);
	
	
	public ElementEntity createNewElement(String elementId, String name, String type, boolean active, Date createdTimestamp, String createdBy,
			ElementEntity parentElement , HashMap<String, Object> elementAttributes);
