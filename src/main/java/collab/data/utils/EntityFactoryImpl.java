...
public class EntityFactoryImpl implements EntityFactory {
	...
	@Override
	public UserEntity createNewUser( String userId, String username, String avatar,
			UserRole role) {
	...
	public ActionEntity createNewAction(String actionId, String elementId, String invokedBy, String actionType,
		...
		return new ActionEntity(actionId, elementId, invokedBy, actionType, creationTimestamp,
				actionAttributes);
	...
	public ElementEntity createNewElement(String elementId, String name, String type, boolean active,
		...
		return new ElementEntity(elementId, name, type,active,createdTimestamp, createdBy, parentElement, elementAttributes);	
